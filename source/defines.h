 ...
 */
#define CONNECT_WAIT_TIMEOUT 30
 ...
 */
#define	PERFORM_TIMER OFF

/*
 * What user modes do you want for darkbot?
 */
#define	DEFAULT_UMODE "+ix-ds"
 ...
 */
#define	GOSLEEP_ACTION	"\1ACTION se duce sa-si toarne un pahar de Lagavulin\1"
#define	WAKEUP_ACTION	"\1ACTION a revenit ... putin ametit\1"
 ...
 */ 
#define	EXISTING_ENTRY	"Stai ba incet ca deja stiu despre ce e vorba"

/*
 * Message to give when there is no mentioned topic
 */ 
#define	NO_ENTRY	"Da ...pula stie despre:"
 ...
 * you want.
 */
#define	CANT_FIND	"N-am gasit nici o pula nimic despre"	/* ... */
#define	NO_TOPIC	"Nu stiu coaie nimic despre"	/* ... */
#define	TRY_FIND	"Ce pula mea incerc sa gasesc!?"
 ...
 * next directive.
 */ 
#define	DONNO_Q	"*clipeste cu ochiul bun*"
 ...
 */
#define	SEEN_REPLY	"De la ultimul pahar cu apa, de acu 7 zile"
 ...
 */
#define	COMPLAIN_REASON	"Ma muie!? Ti-i jali la stomac !?"
...
#define BITCH_DEOP_REASON "BP da careva op!?"
#endif
 ...
 */
#define	DEFAULT_KICK	"Joac-o pe astsa"
 ...
 */
#define	FLOOD_REASON	"Nu da flood ma muie!"
