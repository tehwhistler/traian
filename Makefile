...
pkgdatadir = $(datadir)/darkbot
pkglibdir = $(libdir)/darkbot
pkgincludedir = $(includedir)/darkbot
top_builddir = .
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
ACLOCAL = ${SHELL} /home/whistler/irc/darkbot/missing --run aclocal-1.7
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/whistler/irc/darkbot/missing --run tar
AUTOCONF = ${SHELL} /home/whistler/irc/darkbot/missing --run autoconf
AUTOHEADER = ${SHELL} /home/whistler/irc/darkbot/missing --run autoheader
AUTOMAKE = ${SHELL} /home/whistler/irc/darkbot/missing --run automake-1.7
AWK = gawk
CC = gcc
...
MAKEINFO = ${SHELL} /home/whistler/irc/darkbot/missing --run makeinfo
OBJEXT = o
PACKAGE = darkbot
...
infodir = ${prefix}/info
install_sh = /home/whistler/irc/darkbot/install-sh
...
all-am: source/darkbot$(EXEEXT)
	/usr/bin/cp source/darkbot$(EXEEXT) .

convertdb: source/convertdb$(EXEEXT)
	/usr/bin/cp -f source/convertdb$(EXEEXT) .
